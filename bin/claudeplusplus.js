...
function bootstrap() {
  console.error("[Claude++] First run from source; building the CLI...");
  runOrExit(npmCommand(), installArgs(), "install Claude++ dependencies");
  runOrExit(npmCommand(), ["run", "build"], "build Claude++");
}
