...
[Claude Session Title `0.1.2`](https://github.com/kpkhxlgy0/claude-session-title/releases/tag/v0.1.2) requires Runtime
...
Install or update to Claude Session Title `0.1.2`, then restart Claude Desktop after installing the Runtime.
