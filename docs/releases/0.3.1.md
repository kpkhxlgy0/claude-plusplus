...
- When a newer Claude++ release is available, Settings shows an `Update` review action beside the `CLAUDE++` heading.
...
Run the same installer over an existing Claude++ installation to update it.
